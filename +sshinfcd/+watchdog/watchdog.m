...
% along with sshinfcd. If not, see <https://www.gnu.org/licenses/>.
    ...
    methods
        ...
        % WATCHDOG Constructor
            obj.printer = sshinfcd.watchdog.printer(); 
        end
        ...
        % ERROR Throws a formatted error
            ...
            err = struct(); 
            err.message = 'sshinfcd detected an error in the execution of your command. See the former error message or the logbook for more information.'; 
            err.identifier = 'sshinfcd:watchdogError'; 
            err.stack.file = '';
            err.stack.name = 'sshinfcd';
            err.stack.line = 1;
            error(err); 
        end
