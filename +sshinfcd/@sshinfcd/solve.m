...
% along with sshinfcd. If not, see <https://www.gnu.org/licenses/>.
    ...
    % 0. Start
    obj.watchdog.info(bold('THIS IS SSHINFCD.'));
    ...
    obj.watchdog.startSubTask();
        ...
        obj.preprocessor = sshinfcd.preprocessor(obj.problem, obj.opts);
    ...
    obj.postprocessor = sshinfcd.postprocessor(obj.problem, K, gamma);
    obj.watchdog.startSubTask();
        obj.watchdog.info('Recombining the controller with the D-unstable modes of the weighting filters...'); 
